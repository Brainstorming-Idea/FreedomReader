...
public class SDAdvertsManager {
	 ...
	 * @throws MyException
	 */
	public SDAdvertsManager(Context context,String filePath,boolean isCycle) {
	 ...
	 * @throws MyException
	 */
	public SDAdvertsManager(Context context,String filePath,int iconUnChecked, int iconChecked, boolean isCycle) {
		this.context = context;
		this.filePath = filePath;
		this.isCycle = isCycle;
